...
// Major global bulk export origins to India (per SIH Problem Statement: Australia, US, Mozambique, Russia, Indonesia)
export const SOURCE_EXPORT_PORTS: PortInfo[] = [
  // Indonesia (Thermal & Coking Coal)
  {
    id: 'id-taboneo',
  ...
  },
  {
    ...
    country: 'Indonesia',
    region: 'Southeast Asia',
    primaryCargo: 'Crude & Heavy Fuel Oil / Coal',
    baseRateUSD: 13.10,
    ...
    maxBeam: 42.0,
    maxDraft: 15.0,
    loadingRateTPD: 30000,
  },

  // Australia (Metallurgical Coal & Iron Ore)
  {
    id: 'au-haypoint',
    ...
    maxBeam: 50.0,
    maxDraft: 19.5,
    loadingRateTPD: 65000,
  },
  {
    id: 'au-newcastle',
    name: 'Newcastle Port (PWCS / NCIG)',
    country: 'Australia',
  ...
  },
  {
    ...
    maxBeam: 48.0,
    maxDraft: 17.5,
    loadingRateTPD: 50000,
  },
  {
    id: 'au-hedland',
    name: 'Port Hedland (Utah Point / Inner)',
    country: 'Australia',
    ...
    maxBeam: 55.0,
    maxDraft: 21.0,
    loadingRateTPD: 95000,
  },

  // Mozambique (Moatize Metallurgical Coal)
  {
    id: 'mz-maputo',
  ...
  // Russia (Crude Oil, Metallurgical Coal & Fertilizer)
  {
    id: 'ru-primorsk',
  ...
  {
    id: 'ru-kozmino',
    name: 'Kozmino (Far East Pacific)',
    country: 'Russia',
    region: 'Far East Pacific',
    primaryCargo: 'ESPO Blend Crude & Coking Coal',
    baseRateUSD: 66.80,
  ...
  // United States (Low-Vol Metallurgical Coal & Grains)
  {
    id: 'us-norfolk',
    name: 'Hampton Roads / Norfolk (Pier 6)',
  ...
  {
    id: 'us-houston',
    name: 'Houston / US Gulf Coast',
    country: 'United States',
    region: 'US Gulf',
    primaryCargo: 'WTI Crude & Petcoke',
    baseRateUSD: 48.00,
...
export interface DestinationPortInfo {
  ...
  maxBeam: number; // meters
  maxDraft: number; // meters
  dischargeRateTPD: number; // metric tonnes/day discharge capacity
  berthQueueDaysAvg: number;
  lighterageRequiredForCape: boolean;
  lighterageCostUSDPerMT: number;
  railConnectivityScore: number; // 1-10 hinterland connectivity
  isSIHCorePort: boolean;
}

// All major East Coast India bulk discharge ports (Covering the 7 official SIH problem statement ports + secondary)
export const DESTINATION_INDIAN_PORTS: DestinationPortInfo[] = [
  {
    ...
    maxBeam: 48.0,
    maxDraft: 17.1,
    dischargeRateTPD: 42000,
    berthQueueDaysAvg: 3.8,
    lighterageRequiredForCape: false,
    lighterageCostUSDPerMT: 0,
  ...
  },
  {
    ...
    draftMax: '18.1m Outer Harbour (Capesize)',
    specialty: 'Steel Plant Coking Coal, Crude & Heavy Minerals',
    congestionIndex: 1.02,
    maxLOA: 295,
    maxBeam: 45.0,
    maxDraft: 18.1,
    dischargeRateTPD: 45000,
    berthQueueDaysAvg: 2.4,
    lighterageRequiredForCape: false,
    lighterageCostUSDPerMT: 0,
  ...
  },
  {
    ...
    state: 'Andhra Pradesh',
    draftMax: '20.2m Deepest Draft (Full Capesize)',
  ...
  },
  {
    ...
    name: 'Dhamra Port',
    state: 'Odisha',
    draftMax: '18.5m Deep Draft (All-Weather Cape)',
    specialty: 'All-Weather Deepwater Capesize Coal & Ore',
    congestionIndex: 0.98,
    maxLOA: 300,
    maxBeam: 50.0,
    maxDraft: 18.5,
    dischargeRateTPD: 50000,
    berthQueueDaysAvg: 1.6,
    lighterageRequiredForCape: false,
    lighterageCostUSDPerMT: 0,
    railConnectivityScore: 9.0,
    isSIHCorePort: true,
  },
  {
    id: 'in-gopalpur',
    name: 'Gopalpur Port',
    state: 'Odisha',
    draftMax: '14.5m Draft (Panamax Capable)',
    specialty: 'Mineral Sands, Fertilizer & Power Coal',
    ...
    lighterageRequiredForCape: true,
    lighterageCostUSDPerMT: 3.80,
    railConnectivityScore: 8.2,
    isSIHCorePort: true,
  },
  {
    id: 'in-sagar',
    ...
    state: 'West Bengal',
    draftMax: '12.5m Offshore Lighterage Point',
    specialty: 'Deep Anchorage Lighterage Point for Hooghly/Haldia Bulk Parcels',
    congestionIndex: 1.08,
    maxLOA: 225,
    maxBeam: 32.5,
    maxDraft: 12.5,
    dischargeRateTPD: 16000,
    berthQueueDaysAvg: 3.2,
    lighterageRequiredForCape: true,
    lighterageCostUSDPerMT: 4.50,
    railConnectivityScore: 6.5,
    isSIHCorePort: true,
  },
  {
    id: 'in-haldia',
    ...
    state: 'West Bengal',
    draftMax: '8.5m - 9.2m (Tidal / Handymax Only)',
    specialty: 'Refinery Ingestion & Eastern Hinterland Coal (Tidal Draft Barrier)',
    congestionIndex: 1.14,
    maxLOA: 190,
    maxBeam: 30.5,
    maxDraft: 9.2,
    dischargeRateTPD: 18000,
    berthQueueDaysAvg: 4.6,
    lighterageRequiredForCape: true,
    lighterageCostUSDPerMT: 5.40,
  ...
  },
  {
    ...
    maxDraft: 18.5,
    dischargeRateTPD: 45000,
    berthQueueDaysAvg: 1.8,
    lighterageRequiredForCape: false,
    lighterageCostUSDPerMT: 0,
    railConnectivityScore: 9.1,
    isSIHCorePort: false,
  },
  {
    id: 'in-ennore',
    ...
    maxBeam: 42.0,
    maxDraft: 16.0,
    dischargeRateTPD: 36000,
    berthQueueDaysAvg: 2.8,
    lighterageRequiredForCape: false,
    lighterageCostUSDPerMT: 0,
    railConnectivityScore: 8.9,
    isSIHCorePort: false,
  },
  {
    id: 'in-chennai',
  ...
  },
  {
    ...
    maxBeam: 32.5,
    maxDraft: 14.5,
    dischargeRateTPD: 24000,
    berthQueueDaysAvg: 1.9,
    lighterageRequiredForCape: true,
    lighterageCostUSDPerMT: 3.60,
    railConnectivityScore: 8.4,
    isSIHCorePort: false,
  },
];
